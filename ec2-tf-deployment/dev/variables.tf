...
variable "db_password" {
  description = "Database password — set via TF_VAR_db_password or secrets.auto.tfvars"
  type        = string
  sensitive   = true
}
...
variable "admin_password_hash" {
  description = "Author admin password hash (salt:hash) — set via TF_VAR_admin_password_hash or secrets.auto.tfvars"
  type        = string
  sensitive   = true
}
